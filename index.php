...
<h3>Standard PC Keypad Edition.</h3>
<a class="ts tiny inverted button" href="keyboard.php">Notebook Key Configuration</a>
<a class="ts tiny primary button" href="remote.php">Remote Input (Experimental)</a>
</div>

...
<script>
function googleit(){
	var keywords = document.getElementById("inputbox").value;
	//alert(keywords);
	keywords = keywords.replace(" ","+");
	window.open("http://www.google.com.hk/#safe=off&q=" + keywords, '_blank');
}
</script>
</head>
<body>
...
<a class="ts tiny basic button" onclick="googleit()">Google It</a>
<button id="togglebtn" class="ts tiny positive button" onclick="toggle()">Toggle Q9</button><div id="mode">Q9 Enabled</div>
...
function toggle(){
	if (toggleon == true){
		toggleon = false;
		document.getElementById("mode").innerHTML = "Q9 Disabled";
		document.getElementById("togglebtn").className = "ts tiny negative button";
	}else{
		toggleon = true;
		document.getElementById("mode").innerHTML = "Q9 Enabled";
		document.getElementById("togglebtn").className = "ts tiny positive button";
	}
